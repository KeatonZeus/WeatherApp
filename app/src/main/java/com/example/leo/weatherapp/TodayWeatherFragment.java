package com.example.leo.weatherapp;
...
import com.example.leo.weatherapp.Common.Common;
import com.example.leo.weatherapp.Model.WeatherResult;
import com.example.leo.weatherapp.Retrofit.IOpenWeatherMap;
import com.example.leo.weatherapp.Retrofit.RetrofitClient;
        ...
        compositeDisposable.add(
                ...
                .subscribe(new Consumer<WeatherResult>() {
                    ...
                    public void accept(WeatherResult weatherResult) throws Exception {
                        ...
                        txt_wind.setText(new StringBuilder("Speed: " + String.valueOf(weatherResult.getWind().getSpeed())).append(" m/s ").append("Deg: " + String.valueOf(weatherResult.getWind().getDeg())));
